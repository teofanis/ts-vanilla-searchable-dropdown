...
export function dropdownItem(option: ListOption, instance: SearchableDropdownI) {
  const classes = [
...
export function label(labelText: string, forAttribute: string): HTMLLabelElement {
...
export function input(value: string, id: string, name: string): HTMLInputElement {
